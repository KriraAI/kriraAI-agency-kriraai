              ...
              <div>
                ...
                <div>
                  ...
                  {blog.content.map((section, index) => (
                    <div key={index}>
                      <h3
                        className="font-xl mt-10 mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                        {section.heading}
                      </h3>
                      <p
