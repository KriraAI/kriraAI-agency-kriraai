...
export const metadata: Metadata = {
  title: "404 Not Found | KriraAI",
  description: "The page you were looking for appears to have been moved, deleted or does not exist.",
};
const ErrorPage = () => {
  return (
    <>
      <section className="relative bg-transparent z-10 pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px]">
        <div className="container">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="relative w-full text-center mb-9">
                  <svg
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#66cc66" stopOpacity="0" />
                        <stop offset="1" stopColor="#0099cb" />
                      </linearGradient>
                      <linearGradient
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <AnimationPath
                      classname="w-[167px] h-[167px] mb-16"
                ...
                <Link href={"/"}>
                  <Button
                    ...
                    className="h-12 w-max px-12 rounded-full bg-secondary/60 text-base font-semibold text-white duration-300 dark:bg-black/80 dark:text-white dark:hover:bg-dark/80 xs:hidden sm:hidden md:grid"
                  >
                    Back to home
                  </Button>
                </Link>
        ...
        <div className="absolute bottom-0 left-0 z-[-1] hidden sm:block">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#66cc66" stopOpacity="0" />
                <stop offset="1" stopColor="#66cc66" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#66cc66" />
                <stop offset="1" stopColor="#66cc66" stopOpacity="0" />
              </linearGradient>
              <linearGradient
